						...
						<div class="card">
							<div class="card-body">
								<div class="content-wrapper">
									<h2 class = "font-weight-bold text-center">USER QUESTION</h2>
									<div class="row justify-content-center mt-3">
										...
										<!-- 검색 기능(search: 상품명)-->
											<div class = "row justify-content-center">
												<form method="get" id="searchForm" action="${pageContext.request.contextPath}/question/questionListUser">
													<div>
											...
											<div>
												...
												<!-- 페이지 처음 -->
												<li class="page-item">
													<a class="page-link" href="${pageContext.request.contextPath}/question/questionListUser?currentPage=1&rowPerPage=${rowPerPage}&word=${word}">
														<span>처음</span>
													</a>
												</li>
												...
												<c:if test="${previousPage > 0}">
													<li class="page-item">
														<a class="page-link" href="${pageContext.request.contextPath}/question/questionListUser?currentPage=${previousPage}&rowPerPage=${rowPerPage}&word=${word}">
															<span>이전</span>
														</a>
													</li>
												</c:if>
												...
												<!-- 페이지 1 ~ 10 -->
													<c:forEach var="i" items="${pageList }">
														...
														<c:if test="${i <= lastPage }"> 
															<a class="page-link" href="${pageContext.request.contextPath }/question/questionListUser?word=${word}&rowPerPage=${rowPerPage}&currentPage=${i}">
																<span>${i }</span>
															</a>
														</c:if>
													...
													<c:if test="${nextPage <= lastPage }">
														<li class="page-item"> 
															<a class="page-link" href="${pageContext.request.contextPath }/question/questionListUser?word=${word }&rowPerPage=${rowPerPage }&currentPage=${nextPage}">
																<span>다음</span>
															</a>
														</li>
													</c:if>
